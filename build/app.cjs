...
|.{1,${columnWidth - 1}}([${breaks}]|$)|[^${breaks}]+?([${breaks}]|$)`, "g");
        const lines2 = columnText.match(regex2) || [];
...
var require_extra_typings = __commonJS({
  "node_modules/.pnpm/@commander-js+extra-typings@11.1.0_commander@11.1.0/node_modules/@commander-js/extra-typings/index.js"(exports2, module2) {
...
var require_templates = __commonJS({
  "node_modules/.pnpm/chalk@4.1.2/node_modules/chalk/source/templates.js"(exports2, module2) {
    ...
    function buildStyle(chalk8, styles3) {
      const enabled = {};
    ...
    module2.exports = (chalk8, temporary) => {
      ...
      temporary.replace(TEMPLATE_REGEX, (m, escapeCharacter, inverse, style, close, character) => {
        if (escapeCharacter) {
          ...
          chunk = [];
          chunks.push(styles3.length === 0 ? string : buildStyle(chalk8, styles3)(string));
          styles3.push({ inverse, styles: parseStyle(style) });
        } else if (close) {
          if (styles3.length === 0) {
            throw new Error("Found extraneous } in Chalk template literal");
          }
          chunks.push(buildStyle(chalk8, styles3)(chunk.join("")));
          chunk = [];
          styles3.pop();
        } else {
...
var require_spinners2 = __commonJS({
  "node_modules/.pnpm/cli-spinners@2.9.1/node_modules/cli-spinners/spinners.json"(exports2, module2) {
    module2.exports = {
      dots: {
        interval: 80,
        frames: [
...
var require_cli_spinners2 = __commonJS({
  "node_modules/.pnpm/cli-spinners@2.9.1/node_modules/cli-spinners/index.js"(exports2, module2) {
    "use strict";
...
var require_figures = __commonJS({
  "node_modules/.pnpm/figures@3.2.0/node_modules/figures/index.js"(exports2, module2) {
    ...
    var figures2 = platform === "win32" ? windows : main2;
    var fn = (string) => {
      if (figures2 === main2) {
        return string;
      }
      for (const [key, value] of Object.entries(main2)) {
        ...
        string = string.replace(new RegExp(escapeStringRegexp(value), "g"), figures2[key]);
      }
      return string;
    };
    module2.exports = Object.assign(fn, figures2);
...
// node_modules/.pnpm/string-width@7.0.0/node_modules/string-width/index.js
...
// node_modules/.pnpm/@inquirer+confirm@2.0.15/node_modules/@inquirer/confirm/dist/esm/index.mjs
var import_chalk6 = __toESM(require_source(), 1);

// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/key.mjs
var isBackspaceKey = (key) => key.name === "backspace";
var isEnterKey = (key) => key.name === "enter" || key.name === "return";

// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/use-prefix.mjs
var import_chalk3 = __toESM(require_source(), 1);
var import_cli_spinners3 = __toESM(require_cli_spinners2(), 1);

// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/hook-engine.mjs
...
// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/use-state.mjs
...
// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/use-effect.mjs
...
// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/use-prefix.mjs
var spinner = import_cli_spinners3.default.dots;
function usePrefix(isLoading = false) {
  ...
  if (isLoading) {
    ...
    return import_chalk3.default.yellow(spinner.frames[frame]);
  }
  return import_chalk3.default.green("?");
}

// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/use-ref.mjs
function useRef(val) {
  return useState({ current: val })[0];
}

// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/use-keypress.mjs
...
// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/pagination/use-pagination.mjs
var import_chalk4 = __toESM(require_source(), 1);

// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/utils.mjs
...
// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/create-prompt.mjs
var readline2 = __toESM(require("node:readline"), 1);

// node_modules/.pnpm/@inquirer+type@1.1.5/node_modules/@inquirer/type/dist/esm/index.mjs
...
// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/screen-manager.mjs
...
// node_modules/.pnpm/@inquirer+core@5.1.1/node_modules/@inquirer/core/dist/esm/lib/Separator.mjs
...
var esm_default = createPrompt((config, done) => {
  ...
  let defaultValue = "";
  if (status === "done") {
    formattedValue = import_chalk6.default.cyan(value);
  } else {
    defaultValue = import_chalk6.default.dim(config.default === false ? " (y/N)" : " (Y/n)");
  }
  const message = import_chalk6.default.bold(config.message);
  return `${prefix} ${message}${defaultValue} ${formattedValue}`;
});

// tsbuild/transform.js
...
// node_modules/.pnpm/@inquirer+input@1.2.14/node_modules/@inquirer/input/dist/esm/index.mjs
...
var esm_default2 = createPrompt((config, done) => {
  ...
  if (status === "done") {
    formattedValue = import_chalk7.default.cyan(formattedValue);
  }
  let defaultStr = "";
  if (defaultValue && status !== "done" && !value) {
    defaultStr = import_chalk7.default.dim(` (${defaultValue})`);
  }
  let error = "";
  if (errorMsg) {
...
// node_modules/.pnpm/@inquirer+password@1.1.14/node_modules/@inquirer/password/dist/esm/index.mjs
var import_chalk8 = __toESM(require_source(), 1);
var import_ansi_escapes2 = __toESM(require_ansi_escapes(), 1);
var password = (config, context) => {
  ...
  return esm_default2({
    ...
    transformer(str, { isFinal }) {
      ...
      if (!isFinal) {
        return `${import_chalk8.default.dim("[input is masked]")}${import_ansi_escapes2.default.cursorHide}`;
      }
      return "";
    }
  }, context);
};
var esm_default3 = password;
...
var getI18n = () => {
  ...
  if (localeCode === "zh-CN") {
    const en2 = Object.assign({}, i18n.en);
    i18nOnly = Object.assign(en2, i18n.zh);
    return i18nOnly;
  }
  i18nOnly = i18n.en;
  return i18nOnly;
};
var getCipherKey = (password2) => {
  return import_node_crypto.default.createHash("sha256").update(password2).digest();
};
var to2Str = (n) => n.toString().padStart(2, "0");
var eol = import_node_os2.EOL;
var gestureIcons = [
  "[>---------]",
  "[=>--------]",
  "[==>-------]",
...
var isNull = (v) => v === void 0 || v === null;
var isNullLike = (v) => isNull(v) || v === "" || v === false || Object.prototype.toString.call(v) === "[object Array]" && v.length === 0 || Object.getOwnPropertyNames(v).length == 0;
var isNotBlankString = (v) => Object.prototype.toString.call(v) === "[object String]" && v.length > 0;
var getPasswordFromUser = async (password2, options, command, verbose = false) => {
  let fromEnvironment = false;
  if (isNotBlankString(password2)) {
    if (verbose) {
  ...
  if (options.password === true) {
    password2 = await esm_default3({ message: "please input your password: " });
  } else {
...
// tsbuild/encrypt.js
var i18n2 = getI18n();
var encrypt = async ({ file, password: password2, outFile, showProgress = true, onProgress, compress = true }) => {
  ...
  const cipherKey = getCipherKey(password2);
  const originFileInfo = (0, import_node_fs2.statSync)(file);
  const chunksN = Math.ceil(originFileInfo.size / (64 * 1024));
  const readStream = (0, import_node_fs.createReadStream)(file);
  const brotli = (0, import_node_zlib.createBrotliCompress)({
    params: {
      [import_node_zlib.constants.BROTLI_PARAM_QUALITY]: 3
    }
  });
  const cipher = (0, import_node_crypto2.createCipheriv)("aes256", cipherKey, initVectOrigin);
  const prependInitVect = new PrependInitVectTransform(initVect);
  const writeStreamPath = (0, import_node_path.join)(outFile ?? file + ".Lit");
  if ((0, import_node_fs.existsSync)(writeStreamPath)) {
    const isContinue = await esm_default({
      message: `${writeStreamPath}
${i18n2["app.encrypt.tip.output_file_exists"]}`,
      default: true
    });
    if (!isContinue) {
      console.log(i18n2["app.encrypt.tip.redesignate_output_file"]);
      return;
    }
  }
  const writeStream = (0, import_node_fs.createWriteStream)(writeStreamPath);
  const spinner2 = ora({
    text: `${i18n2["app.encrypt.ui.progress"]} 00% [----------]`,
    prefixText: ` ${source_default.blue("(\xB0\u30FC\xB0\u3003)")} ${i18n2["app.encrypt.ui.elapsed_time"]}: 00:00${eol}`
  });
    ...
    updateProcess: (percent) => {
      ...
      if (showProgress) {
        ...
        if (floored > lastProgressPercent) {
          ...
          spinner2.text = `${i18n2["app.encrypt.ui.progress"]} ${to2Str(floored)}% ${gestureIcon(percent)}`;
        }
  ...
  const clock = (rs) => {
    ...
    timerId = setTimeout(() => {
      ...
      timerId = null;
      const now = Date.now();
      const timeUsed = Math.floor((now - startTime) / 1e3);
      ...
      if (encryptEnd) {
        spinner2.prefixText = ` ${source_default.green("(\xB0\u30FC\xB0\u3003)")} ${i18n2["app.encrypt.ui.total_time"]}: ${to2Str(timeUsedMinutes)}:${to2Str(timeUsedSeconds)}${eol}`;
        spinner2.succeed(`${i18n2["app.encrypt.ui.encryption_completed"]}\u{1F389}`);
        rs();
        return;
      }
      ...
      spinner2.prefixText = ` ${source_default.blue("(\xB0\u30FC\xB0\u3003)")} ${i18n2["app.encrypt.ui.elapsed_time"]}: ${to2Str(timeUsedMinutes)}:${to2Str(timeUsedSeconds)} ${i18n2["app.encrypt.ui.estimated_remaining_time"]}: ${to2Str(timeLeftMinutes)}:${to2Str(timeLeftSeconds)}${eol}`;
      clock(rs);
    }, 300);
  };
  return await new Promise((rs, rj) => {
    ...
    let runningStream = readStream.on("error", throwError).pipe(progress).on("error", throwError);
    if (compress) {
      runningStream = runningStream.pipe(brotli).on("error", throwError);
    }
    runningStream.pipe(cipher).on("error", throwError).pipe(prependInitVect).on("error", throwError).pipe(writeStream).on("error", throwError);
    if (showProgress) {
      timerId = setTimeout(() => {
        spinner2.start();
        clock(rs);
...
var i18n3 = getI18n();
var getInitVect = async (file) => await new Promise((rs) => {
  const readInitVect = (0, import_node_fs3.createReadStream)(file, { end: 19 });
  let iv = Buffer.from([]);
...
var decrypt = async ({ file, password: password2, outFile, showProgress = true, onProgress }) => {
  const originFileInfo = (0, import_node_fs3.statSync)(file);
  const chunksN = Math.ceil(originFileInfo.size / (64 * 1024));
  const initVect = await getInitVect(file);
  if (initVect === void 0 || initVect.byteLength === 0) {
    console.log(i18n3["app.decrypt.error.fail_to_read_init_vector"]);
    return;
  }
  const initVectOrigin = [];
  const len = initVect.byteLength;
  if (len !== 20) {
    console.log(i18n3["app.decrypt.error.file_header_wrong"]);
    return;
  }
  ...
  const cipherKey = getCipherKey(password2);
  const decipher = (0, import_node_crypto3.createDecipheriv)("aes256", cipherKey, Buffer.from(initVectOrigin));
  const brotli = (0, import_node_zlib2.createBrotliDecompress)();
  const originFile = (0, import_node_path2.parse)(file);
  const readStream = (0, import_node_fs3.createReadStream)(file, { start: 20 });
  const writeStreamPath = outFile ? (0, import_node_path2.join)(outFile) : (0, import_node_path2.resolve)((0, import_node_path2.dirname)(file), `${originFile.name}.Til`);
  if ((0, import_node_fs3.existsSync)(writeStreamPath)) {
    const isContinue = await esm_default({
      message: `${writeStreamPath}
${i18n3["app.decrypt.tip.output_file_exists"]}`,
      default: true
    });
    if (!isContinue) {
      console.log(i18n3["app.decrypt.tip.redesignate_output_file"]);
      return;
    }
  }
  const writeStream = (0, import_node_fs3.createWriteStream)(writeStreamPath);
  const spinner2 = ora({
    text: `${i18n3["app.decrypt.ui.progress"]} 00% [----------]`,
    prefixText: ` ${source_default.blue("(\xB0\u30FC\xB0\u3003)")} ${i18n3["app.decrypt.ui.elapsed_time"]}: 00:00${eol}`
  });
  let lastProgressPercent = 0;
  let currentProgressPercent = 0;
  const startTime = Date.now();
  const progress = new ProgressTransform({
    ...
    updateProcess: (percent) => {
      ...
      if (showProgress) {
        ...
        if (floored > lastProgressPercent) {
          lastProgressPercent = floored;
          spinner2.text = `${i18n3["app.decrypt.ui.progress"]} ${to2Str(floored)}% ${gestureIcon(percent)}`;
        }
        currentProgressPercent = percent;
      }
    }
  ...
  const clock = (rs) => {
    ...
    timerId = setTimeout(() => {
      ...
      if (decryptEnd) {
        spinner2.prefixText = ` ${source_default.green("(\xB0\u30FC\xB0\u3003)")} ${i18n3["app.decrypt.ui.total_time"]}: ${to2Str(timeUsedMinutes)}:${to2Str(timeUsedSeconds)}${eol}`;
        spinner2.succeed(`${i18n3["app.decrypt.ui.decryption_completed"]}\u{1F389}`);
        rs();
        return;
      }
      const timeLeft = Math.ceil((100 - currentProgressPercent) / currentProgressPercent * timeUsed);
      const timeLeftMinutes = Math.floor(timeLeft / 60);
      const timeLeftSeconds = timeLeft - timeLeftMinutes * 60;
      spinner2.prefixText = ` ${source_default.blue("(\xB0\u30FC\xB0\u3003)")} ${i18n3["app.decrypt.ui.elapsed_time"]}: ${to2Str(timeUsedMinutes)}:${to2Str(timeUsedSeconds)} ${i18n3["app.decrypt.ui.estimated_remaining_time"]}: ${to2Str(timeLeftMinutes)}:${to2Str(timeLeftSeconds)}${eol}`;
      clock(rs);
    }, 300);
  };
  return await new Promise((rs, rj) => {
    ...
    let runningStream = readStream.on("error", throwError).pipe(progress).on("error", throwError).pipe(decipher).on("error", throwError);
    if (isCompressed) {
      runningStream = runningStream.pipe(brotli).on("error", throwError);
    }
...
// tsbuild/version.js
var APP_VERSION_INFO = "LitAES v1.0.8(2024/1/10 23:31:50) @Cufoon";

// tsbuild/app.js
var i18n4 = getI18n();
var program2 = new Command();
program2.name("litaes").description("A cli tool to help encrypt and decrypt your data using aes-256.").version(APP_VERSION_INFO, "-v, --version", "Output the version information").helpOption("-h, --help", "The help information").option("-V", "Alias for --version").passThroughOptions().action((options, command) => {
  if (options.V === true) {
...
program2.command("encrypt").alias("e").description("Encrypt a file").argument("<file>", "The file path of the file to encrypt").argument("[password]", "The password to encrypt a file using aes256").option("-v, --verbose", "Show more detail information").option("-o, --out-file <file>", "The encrypted output file path").option("-nc, --no-compress", "Not compress file using brotli before encrypt").addOption(new Option("-p, --password [password]", "The password to encrypt a file using aes256").env("LITAES_PASSWORD")).action(async (file, password2, options, command) => {
  password2 = await getPasswordFromUser(password2, options, command, options.verbose);
  if (options.verbose) {
  ...
  if (password2 !== void 0) {
    try {
      ...
      console.log(i18n4["app.error.tip"]);
      console.error(e);
    }
  }
});
program2.command("decrypt").alias("d").description("Decrypt a file encrypted by this tool").argument("<file>", "The file path of the file to decrypt").argument("[password]", "The password to decrypt a file using aes256").option("-v, --verbose", "Show more detail information").option("-o, --out-file <file>", "The decrypted output file path").addOption(new Option("-p, --password [password]", "The password to decrypt a file using aes256").env("LITAES_PASSWORD")).action(async (file, password2, options, command) => {
  password2 = await getPasswordFromUser(password2, options, command, options.verbose);
  if (options.verbose) {
    console.log("file", file);
    console.log("password", password2);
  ...
  if (password2 !== void 0) {
    try {
      await decrypt_default({ file, password: password2, outFile: options.outFile });
    } catch (e) {
      console.log(i18n4["app.error.tip"]);
      console.error(e);
    }
