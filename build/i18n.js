const en = {
    ...
    'app.decrypt.error.fail_to_read_init_vector': 'Failed to read initial vector!',
    'app.decrypt.error.file_header_wrong': 'Encrypted file header error!',
    'app.decrypt.tip.output_file_exists': 'Target output file exists, do you want to overwrite?',
    'app.decrypt.tip.redesignate_output_file': 'Please specify the target output file again and execute this program.',
    ...
    'app.encrypt.tip.output_file_exists': 'Target output file exists, do you want to overwrite?',
    'app.encrypt.tip.redesignate_output_file': 'Please specify the target output file again and execute this program.',
...
const zh = {
    ...
    'app.decrypt.tip.redesignate_output_file': '请重新指定目标输出文件再执行本程序。',
    ...
    'app.encrypt.tip.redesignate_output_file': '请重新指定目标输出文件再执行本程序。',
